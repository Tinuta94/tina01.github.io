...
// solarSystem[9].push({'Pluto', 'true', 'Charon'})
...
// a ringSystem (where ringSystem: true), and ignore the others. 
...
//sumOfSatellites = system["jupiter"].satellites + system["uranus"].satellites + system["saturn"].satellites + system["neptune"].satellites
...
//(radiusp is radius at the poles, radiuse is radius at the equator).
...
jupiterMomentum = system["jupiter"].velocity * system["jupiter"].mass
plutoMomentum = system["pluto"].velocity * system["pluto"].mass
